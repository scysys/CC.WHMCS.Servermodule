...
$sql_tracks = "SELECT t.id, t.pathname, t.title, t.artistid FROM (SELECT id, pathname, title, artistid FROM tracks WHERE accountid = '$cc_accountid' LIMIT 7500) t";
  ...
  <div class="m-portlet__body"> 
    ...
    <div id="m_table_1_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
      <div class="row">
        <div class="col-sm-12">
          ...
          if ( $result_tracks->num_rows > 0 ) {
            ...
            while ( $row = $result_tracks->fetch_assoc() ) {
              ...
              echo "<td class='sp_no_cover'>Keine Cover in dieser Ansicht</td>";
              
              echo "<td class='sp_no_artist'>" . $cc_track_artist . "</td>";
              
              echo "<td class='sp_no_title'>" . $cc_track_title . "</td>";
		...
		&artist=" . base64_encode( $cc_track_artist ) . "
		&title=" . base64_encode( $cc_track_title ) . "
