...
if (isset($_POST['submitplayer03options']))
{
...
{$LANG.streampanel_player_lyrics}
    ...
    <div class="card-footer">
        ...
        <pre><code>https://scripts.streampanel.net/cc/player/cache/{$username|base64_encode|replace:"=":""}_03.html</code></pre>
    </div>
</div>