...
$sql_playbackstats_tracks = "SELECT * FROM playbackstats_tracks WHERE accountid = '".mysql_real_escape_string($cc_accountid)."' AND starttime >= '".date('Y')."-06-01 00:00:00' AND endtime <= '".date('Y')."-06-31 23:59:59'";
