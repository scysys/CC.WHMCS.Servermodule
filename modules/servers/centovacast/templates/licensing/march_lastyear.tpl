...
$sql_playbackstats_tracks = "SELECT * FROM playbackstats_tracks WHERE accountid = '".mysql_real_escape_string($cc_accountid)."' AND starttime >= '2023-03-01 00:00:00' AND endtime <= '2023-03-31 23:59:59'";
